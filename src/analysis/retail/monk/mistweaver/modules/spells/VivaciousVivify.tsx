  ...
  get guideSubsection(): JSX.Element {
    const explanation = (
      <p>
        ...
        is a buff granted when you cast <SpellLink spell={getCurrentRSKTalent(this.selectedCombatant)}/>. It increases the healing of your next{' '}
        <SpellLink spell={SPELLS.VIVIFY} /> by {formatPercentage(VIVACIOUS_VIVIFICATION_BOOST)}%
        and makes it an instant cast. Try to consume this buff without letting it refresh as
